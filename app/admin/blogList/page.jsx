                        ...
                        <tbody>
                            {
                                blogs.map((item, index) => {
                                    return <BlogTableItem item={item} key={index} title={item.title} author={item.author} id={item._id} date={item.date} fetchBlogs={fetchBlogs} handleOpen={()=>handleOpen(item)} handleDeleteModal={()=>handleDeleteModal(item._id)}/>
                                })
